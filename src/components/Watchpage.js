...
const Watchpage = () => {
  ...
  return (
    <div className=" flex xs:flex-col sm:flex-col md:flex-row lg:flex-row xl:flex-row 2xl:flex-row  gap-2 h-max  w-full   ">
      <div className=" flex flex-col  gap-4 h-max overflow-y-scroll scrollbar-hide -moz-scrollbar-none pb-32 w-max p-2 border-r-2   ">
